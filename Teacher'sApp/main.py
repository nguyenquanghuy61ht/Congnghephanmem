import threading, cv2, os, sqlite3, shutil, firebase, ConnectionCheck, time, ViewMyClass
...
class MyGui:
    ...
    def __Config(self):
        self.__master.geometry("650x550")
    ...
    def __frame1Config(self):
        ...
        Label(frame, text="Thêm khuôn mặt", font=("Arial", 20, "bold")).grid(
            row=0, column=0, columnspan=2
        )
        Label(frame, text="Nhập ID sinh viên:", font=("Arial", 20, "bold")).grid(row=1, column=0)
        etr = Entry(frame, font=("Arial", 20), justify="left")
